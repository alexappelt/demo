            ...
            <div id="book-appointment-wizard" class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                ...
                <div id="wizard-frame-1" class="wizard-frame">
                    ...
                    <div class="command-buttons">
                        <button type="button" id="button-next-1" class="btn button-next btn-primary" style="color:black; background:#CDAD61;"
                                data-step_index="1">
                            <?= lang('next') ?>
                ...
                <div id="wizard-frame-2" class="wizard-frame" style="display:none;">
                    ...
                    <div class="command-buttons">
                        ...
                        <button type="button" id="button-next-2" class="btn button-next btn-primary" style="color:black; background:#CDAD61;"
                                data-step_index="2">
                            <?= lang('next') ?>
                            <span class="glyphicon glyphicon-forward"></span>
                        </button>
                ...
                <div id="wizard-frame-3" class="wizard-frame" style="display:none;">
                    <div class="frame-container">
                        ...
                        <div class="frame-content row">
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                    <label for="first-name" class="control-label">Nome Completo *</label>
                                    <input type="text" id="first-name" class="required form-control" maxlength="100" />
                                </div>
                                <div class="form-group" hidden="true">
                                    <label for="last-name" class="control-label"><?= lang('last_name') ?> *</label>
                                    <input type="text" id="last-name" value=".." class="form-control" maxlength="120" />
                                </div> 
                                <div class="form-group">
                    ...
                    <div class="command-buttons">
                        ...
                        <button  type="button" id="button-next-3" class="btn button-next btn-primary" style="color:black; background:#CDAD61;"
                                data-step_index="3">
                            <?= lang('next') ?>
                            <span class="glyphicon glyphicon-forward"></span>
                        </button>
                ...
                <div id="wizard-frame-4" class="wizard-frame" style="display:none;">
                    ...
                    <div class="command-buttons">
                        ...
                        <form id="book-appointment-form" style="display:inline-block" method="post">
                            <button id="book-appointment-submit" type="button" class="btn btn-success" style="color:black; background:#CDAD61;">
